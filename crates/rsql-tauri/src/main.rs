...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            commands::project_db_select,
            commands::project_db_insert,
            commands::project_db_delete,
            commands::query_db_select,
            commands::query_db_insert,
            commands::query_db_delete,
            commands::workspace_save,
            commands::workspace_load_all,
