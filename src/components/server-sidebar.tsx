    ...
    <div className="flex h-full flex-col border-r border-sidebar-border bg-sidebar select-none">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-auto p-1">
        {(() => {
          ...
          const renderSchemas = (pid: string) => {
          ...
          return (
            <>
              {Array.from(serverGroups.entries()).map(([fp, pids]) => {
                const primaryDetails = projects[pids[0]];
                          ...
                          if (dbPid) {
                            ...
                            return (
                              <div key={dbName}>
                                ...
                                {isDbConnected && isOpen(dbKey, true) && renderSchemas(dbPid)}
                              </div>
                            );
                          } else {
...
/** Dialog for adding a database to a server group */
