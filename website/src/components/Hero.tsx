          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[minmax(0,1.12fr)_300px] lg:items-end">
            <div className="max-w-4xl">
              ...
              <p className="mt-7 max-w-2xl text-lg leading-relaxed text-muted-foreground md:text-[1.28rem]">
                RSQL focuses on the query loop itself: faster feedback, denser
                surfaces, and a PostgreSQL client that feels edited instead of
                accumulated.
              </p>
              ...
              <div className="mt-6 space-y-5">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                    Designed to feel quieter, faster, and more intentional than
                    legacy admin tools.
                  </p>
                </div>
                <div className="space-y-2">
                  {featureStrip.map((item) => (
                    <div
                      key={item}
                      className="flex items-center justify-between gap-3 border-b border-border/35 pb-2 text-sm"
                    >
                      <span>{item}</span>
