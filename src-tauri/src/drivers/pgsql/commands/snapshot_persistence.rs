...
#[derive(Clone)]
pub(crate) struct VirtualSnapshotMeta {
...
pub(crate) async fn snapshot_upsert_metadata(
    app_state: &AppState,
    project_id: &str,
    query_id: &str,
    sql: &str,
...
pub(crate) async fn snapshot_store_page(
    app_state: &AppState,
    query_id: &str,
    page_index: usize,
    packed_page: &str,
...
pub(crate) async fn snapshot_load_page(
    app_state: &AppState,
    query_id: &str,
    page_index: usize,
...
pub(crate) async fn snapshot_load_metadata(
    app_state: &AppState,
    query_id: &str,
...
pub(crate) async fn snapshot_cleanup_query(
    app_state: &AppState,
    query_id: &str,
) -> std::result::Result<(), AppError> {
    let conn = app_state
...
pub(crate) async fn restore_virtual_from_snapshot(
    app_state: &AppState,
    query_id: &str,
